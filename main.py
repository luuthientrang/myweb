...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'LuuThienHanhTrang'
...
def main():
 ...
 {
   'name':'mua sua',
   'description':'mua 2 l sua'
 },
 {
   'name':'kiem tien',
   'description':'rut 500k ATM'
 }
  ]
...
def showSignUp():
   ...
   if form.validate_on_submit():
      ...
      user = {'firstname':_firstname,'lastname':_lastname , 'email':_email, 'password':_password}
...
app = Flask(__name__)
app.config['SECRET_KEY']='LTHT Web App'
